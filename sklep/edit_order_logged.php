...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id']) && ctype_digit($_GET['id'])) {
    ...
    $query = "SELECT * FROM zamowienia_users WHERE id = ?";
    ...
    $query = "UPDATE zamowienia_users SET status = ?, closed_at = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
...
<head>
    ...
    <title>Edytuj Zamówienie Zalogowanego Użytkownika</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">
    <h1 class="mb-4">Edytuj Zamówienie Zalogowanego Użytkownika</h1>
    <form action="edit_order_logged.php" method="post">
        ...
        <a href="admin_dashboard.php#orders_logged_users" class="btn btn-secondary">Anuluj</a>
    </form>
</div>
